    ...
    return (
        ...
        <>
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
                ...
                <Nav.Link style={{alignSelf:'baseline'}} href="/">
                ...
                <Nav.Link href="/application" style={{alignSelf:'baseline'}} >
                ...
                <Nav.Link  href="/example" style={{alignSelf:'baseline'}}>
                    <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-file-earmark-image" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <Nav.Link href="/mathematics" style={{alignSelf:'baseline'}} >
